...
void scrypt_N_1_1_256_sp_sse2(const char *input, char *output, char *scratchpad, unsigned int Nfactor);
extern void (*scrypt_N_1_1_256_sp)(const char *input, char *output, char *scratchpad, unsigned int Nfactor);
#endif
