...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Aptcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"node1.aptcoin.org", "node1.aptcoin.org"},
    {"node2.aptcoin.org", "node2.aptcoin.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Aptcoin is probably already running."), addrBind.ToString().c_str());
        else
