...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 APT
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 APT mininput
...
public:
    ...
    {
        uint256 thash;
        unsigned int hpb = GET_HPB(hashPrevBlock);
        scrypt_N_1_1_256(BEGIN(nVersion), BEGIN(thash), GetNfactor(hpb, nTime));
        return thash;
    }
